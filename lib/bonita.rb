...
require 'bonita/models/bpm/timer_event_trigger'
...
require 'bonita/mappings/bpm/timer_event_trigger_mapping'
...
require 'bonita/resources/bpm/timer_event_trigger_resource'
